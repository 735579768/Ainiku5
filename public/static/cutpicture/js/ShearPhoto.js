...
ShearPhoto.prototype = {
          ...
          complete:function(serverdata) {
                    ...
                    complete.innerHTML = AllImgSrc + '<div class="completeTxt"><strong><i></i>恭喜你！截图成功</strong> <p>以上是你图片的' + length + '种尺寸</p><a href="javascript:;" id="completeA">插入图片</a></div>';
          ...
          SendPHP:function(postArgs) {
                    ...
                    this.MyAjax.carry({
                              ...
                              success:function(serverdata) {
										...
										if(typeof(this_.arg.complete2)=='function')this_.arg.complete2(serverdata);
