<div id="admin-header" class="admin-header">
    ...
    <ul class="tool cl">
        ...
        <li><a href="javascript:;" target="_blank"><i class="fa fa-home"></i>查看网站</a></li>
        <li class="downmenu"><a href="javascript:;"><i class="fa fa-user"></i>个人信息</a>
            <ul class="pwdinfo">
                <li><a href="javascript:;">清空缓存</a></li>
